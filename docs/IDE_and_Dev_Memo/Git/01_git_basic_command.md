...
=================================================================
### リポジトリが Could not read from remote repository となっていた場合

------------------------------------------------------
Cloning into 'kakicloud'...
...
## リモートから取得したブランチに切り替え（先に↑にてリモートのブランチを取得しておく）
※ブランチ名「origin/fix/products」
git checkout -b origin/fix/products origin/fix/products

mainブランチに持ってくる場合、こんな感じ
